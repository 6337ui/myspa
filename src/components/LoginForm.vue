          ...
          <form @submit.prevent="handleLogin" class="mt-8 grid grid-cols-6 gap-6">
            <div class="col-span-6">
              ...
              <input
                  ...
                  :class="{'border-red-600': error && !form.email}"
              />
            </div>
            <div class="col-span-6">
              ...
              <input
                  ...
                  required
                  class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                  :class="{'border-red-600': error && !form.password}"
              />
            </div>
            <div class="col-span-6">
              <button
                  type="submit"
                  :disabled="loading"
                  class="inline-flex w-full justify-center rounded-md border border-transparent bg-blue-600 py-2 px-4 text-base font-semibold text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:w-auto"
              >
            ...
            <div class="col-span-6 text-center">
              <p class="text-sm text-gray-500 dark:text-gray-400">
                ...
                <router-link to="/registration" class="font-medium text-blue-600 hover:text-blue-500">
                  Sign in
                </router-link>
              </p>
            </div>
